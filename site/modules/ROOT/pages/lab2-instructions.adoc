...
image::lab2-create-ai-settings.png[Create with AI Settings]
...
image::lab2-agent-tools.png[Agent Tools]
...
| **Cypher Templates**
| Company Details, Company Risk Factors, Companies Owned by Asset Manager, Company Financial Metrics, Company Products Offered, Documents by Company Identifier, Company Executives
...
This completes Part 1 (No-Code Track) of the workshop. Continue to xref:lab3.adoc[Lab 3: Intro to Bedrock and Agents] to set up your development environment and learn how AI agents work with LangGraph.
