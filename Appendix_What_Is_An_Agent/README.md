...
Return to the main workshop path — [Lab 3 - Semantic Search and GraphRAG](../Lab_3_GraphRAG_Search) — to search a Neo4j knowledge graph with vector and vector-cypher retrieval.
