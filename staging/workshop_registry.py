...
This file is the source of the generated cell in
`notebooks/lab-01-verify-environment.ipynb`. After changing anything here, run
`./scripts/sync_notebook_module.py` or `tests/test_notebook_drift.py` fails.
"""
